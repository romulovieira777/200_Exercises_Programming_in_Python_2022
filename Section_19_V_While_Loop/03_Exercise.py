...
Use the stochastic gradient descent algorithm to find the minimum of the loss function given by the formula: L(w) = w^2
- 4w.
...
6. We define the derivate of a function:

    derivate = lambda w: 2 * w - 4

To find the minimum of the L function, move along the opposite direction to the direction of the gradien by updating the
value w_0 as follows:

    w_0 = w_0 - learning_rate * derivate(w_prev)
