...
The contents of the file plw.txt were loaded as follows:
    ...
    with open('../Files/plw.txt', 'r') as file:
        lines = file.readl().splitlines()
...
Expected result:
    ...
    [['PLAYWAY'], ['PlayWay', 'is', 'a', 'producer', 'and', 'publisher', 'of', 'computer', 'and', 'mobile', 'games.',
     'The', 'company', 'is', 'characterized', 'by', 'a', 'very', 'large', 'number', 'of', 'development', 'teams', 'and',
     'a', 'large', 'number', 'of', 'games', 'produced', 'simultaneously.'], ['PlayWay', 'sells,', 'among', 'others',
     'via', 'the', 'STEAM', 'portal,', 'AppStore', 'and', 'GooglePlay.', 'The', 'US', 'and', 'German', 'markets', 'are',
     'the', 'two', 'largest', 'markets', 'for', 'the', "Group's", 'sales.'], ['In', 'addition,', 'the', 'company', 'has',
